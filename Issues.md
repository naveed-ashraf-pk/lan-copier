- The file available disk space do not update after transfer finish, on even on the reload/refresh button click in destination. i have to navigate to different folder to get it updated.
- it also not updating on deleting files using delete button.
...
- selection buttons, we have different optons like select all, missing etc. but need option to select 'same' as well.
